...
//        for (i in headers.indices) {
        ...
        var td1 = TimeData(0, "8:00 - 10:45\nMysore\nMonika",
            R.color.mysorecolor, R.color.white, start.plusMinutes(8*60).millis,
            start.plusHours(10).plusMinutes(45).millis)
        values.add(td1)


        var td11 = TimeData(0, "11:00 - 12:15\nRegeneracja - Agnieszka",
            R.color.regeneracjacolor, R.color.white, start.plusMinutes(11*60).millis,
...
//        values.add(td111)
        ...
        val td3 = TimeData(0, "12:30 - 13:45\nAshtanga II\nAgnieszka",
            R.color.ashtanga2color, R.color.white, start.plusMinutes(12*60+30).millis,
