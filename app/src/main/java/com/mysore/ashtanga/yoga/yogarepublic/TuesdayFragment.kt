...
class TuesdayFragment: Fragment() {
    ...
    private val mLongHeaders = SharedDate.mLongerHeaders//private val mLongHeaders: List<String> = Arrays.asList("Mała Sala", "Duża Sala")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val begining = (SharedDate.tuesdayBig[0].getValue("start") as Double).toLong()
    ...
    private fun getTimetable(
        ...
        //SALA 1 ---------------------
        SharedDate.tuesdaySmall.forEach {
